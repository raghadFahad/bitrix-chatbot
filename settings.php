<?php
define('C_REST_CLIENT_ID','local.603ca3ab159cf8.06823685');//Application ID
define('C_REST_CLIENT_SECRET','inhdmo9ejH9NHAFAfABsVKOEUSCwwfgryxBnZ4y1ADPAeDDm8p');//Application key
// or
